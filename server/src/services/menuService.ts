...
class MenuService {
   static sortMenuItemsByRatingSentiment(data: any) {
   ...
   async sortMenuItemsByRatingSentiment(
   ...
   async getMealType(menuId: number): Promise<string> {
   ...
   async getMenuItems(mealType: string, menuIds: number[]): Promise<MenuItem[]> {
